...
import com.mz.mybatis.product.model.service.ProductService;
import com.mz.mybatis.product.model.vo.Product;

/**
 * Servlet implementation class adminPayManagement
 */
@WebServlet("/paymanage.do")
public class adminPayManagement extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminPayManagement() {
        super();
