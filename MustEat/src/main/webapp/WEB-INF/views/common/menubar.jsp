<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.mz.mybatis.member.model.vo.Member, com.mz.mybatis.store.model.vo.*"%>
<%  
...
<style>
		html{
			cursor: url('/<%=request.getContextPath()%>/cursor.cur'), auto;
		}
				...
				<div class="webLogo">
					...
					<% if(loginUser == null) { %> <!-- 로그인하지 않은 경우 -->
						<div class="bbtn">
		                	...
		                	<button class="custom-btn btn-8"><a href="<%= contextPath %>/tosuserlist.no" style="text-decoration: none;">ME❥MZ</a></button>
            			</div>
