	          ...
	          <div class="sellerInfo">
	            ...
	            <div class="inner">
 				...
 				<div class="orderButton">
		            ...
		            <c:if test="${ol.orderStatus != 1 && ol.deliveryStatus == '상품준비중' }">
						<a class="plain-btn btn" id="orderConfirm" onclick="return purchaseConfirm(${ol.orderNo }, '${ol.deliveryStatus }');">구매취소</a>  
					</c:if>
			
	
					<c:if test="${ol.orderStatus == 2 }">
						<!-- 구매확정시 보이도록 설정 -->
		            	<a href="address.do?" class="plain-btn btn">구매하기</a>
		            </c:if>
