...
<body>
	...
	<!-- 주문된 상품의 상세페이지 -->
      ...
      <h3 class="detailTitle">주문 상세정보</h3>
        ...
        <table class="orderTb" style="width:100%;">
	        <thead>
	          <tr>
	        ...
	        <tbody>
				<c:forEach var="odl" items="${list }">
					<tr class="group">
						<td><span class="thm ordernum2">${odl.orderNo }</span></td>
						<td class="product">
							<div id="productName" align="left">${odl.productName }</div>
						</td>
						<td class="money"><em class="thm">${odl.price }</em>원<br>
							<span>(${odl.amount }개)</span></td>
						...
						<td class="orderStatus">${odl.deliveryStatus }</td>
					</tr>
				</c:forEach>
			</tbody>
        </table>
	                  ...
	                  <dl class="first">
	                    ...
	                    <dd>
	                      ...
	                      <ul class="price_list">
	                        <li>
	                          <span>상품금액</span>
	                          <p class="thm"><em><fmt:formatNumber value="${detail.price }" pattern="#,###" /></em>원</p>
	                        </li>
	                        <li>
	                          <span>배송비</span>
	                          <p class="thm"><em><fmt:formatNumber value="${detail.deliveryPrice }" pattern="#,###" /></em>원</p>
	                        </li>
	                        <li>
	                          <span>적립금사용</span>
	                          <p class="thm"><em><fmt:formatNumber value="${detail.discountPrice }" pattern="#,###" /></em>원</p>
	                        </li>
	                      </ul>
	                    </dd>
	                  </dl>
	            ...
	            <td class="last_money" colspan="6" style="vertical-align:top;">
	                <div class="total_price">
	                  <dl class="total">
	                    ...
	                    <!-- 주문금액 -->
	                    <div class="total_price">
	                        <p><em><fmt:formatNumber value="${detail.totalPrice }" pattern="#,###" /></em>원</p>
	                   </div>
	                </div>
	            </td>
	          </tr>
        ...
        <table class="orderPlace" style="width:100%;">
            <tr>
