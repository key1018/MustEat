	 ...
	 <script>
        ...
        function checkEmail(){
           ...
           $("#doubleEmail").val("Y");
            ...
            if(document.getElementById('email').value ==''){
                ...
                $.ajax({
                    url:"${pageContext.servletContext.contextPath}/emailCheck.me",
       ...
       function phoneCheck(){
           ...
           if(document.getElementById('phone').value ==''){
               ...
               $("#show").css("display", "");
               $.ajax({
                   url:"${pageContext.servletContext.contextPath}/phoneCheck.me",
           ...
           if(document.getElementById('phone2').value != ranNum){
			...
			<script>
      		...
      		function removeImg() {
      			...
      			$("#existIcon").attr("src",'${pageContext.servletContext.contextPath}/resources/image/user.png');
		...
		<script>
	        	...
	        	function deleteMember() {
	        		 ...
	        		 if( $("#deletePwd").val() == "" ) {
	        			 ...
	        			 $("#alert-fail").hide();
	        			 return false;
	        		 } else if( $("#deletePwd").val() != "${loginUser.memPwd}") {
