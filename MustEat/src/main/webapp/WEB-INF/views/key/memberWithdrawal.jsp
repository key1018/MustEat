...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath() %>/resources/css/memberWithdrawal.css" />
<link rel="stylesheet"
...
<body>
	...
	<div class="delete-area">
		...
		<div class="deleteInfo_first">
			<img src="${pageContext.servletContext.contextPath}/resources/image/key/check-mark-black.png" alt=""> 
			<br><br>
			<div>
				<strong>회원탈퇴가 <span>완료되었습니다.</span> </strong>
			</div>
		</div>

		<div class="deleteInfo_middle">
			<div id="text1">
				그동안 <span>머스트잇 </span>서비스를 이용해주셔서 감사합니다.
			</div>
